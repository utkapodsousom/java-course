...
public class Exercise3_17 {
    public static void main(String[] args) {
        ...
        switch (computerChoice) {
            case 0: computerFigure = "scissor"; break;
            case 1: computerFigure = "rock"; break;
            case 2: computerFigure = "paper"; break;
        }

        switch (userChoice) {
            case 0: userFigure = "scissor"; break;
            case 1: userFigure = "rock"; break;
            case 2: userFigure = "paper"; break;
        }
